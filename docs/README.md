...
1. **[Addons e serviços complementares](./addons.md)**: introdução aos plugins de rede, CoreDNS, Metrics Server, Gateway API, NFS Subdir Provisioner, Kube-vip e Kubernetes Dashboard.
